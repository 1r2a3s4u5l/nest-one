...
export class UsersService {
  ...
  async activateUser(activateUser: ActivateUserDto) {
    const user = await this.userRepo.findByPk(activateUser.userId);
  ...
  async deactivateUser(activateUser: ActivateUserDto) {
    const user = await this.userRepo.findByPk(activateUser.userId);
